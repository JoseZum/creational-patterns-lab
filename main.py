...
if __name__ == "__main__":
    ...
    tenis = factory_tennis.crearZapato(1, "Nike Air", "Deportivo", 50,
                                       42, "Blanco con azul", "Tela y goma", 120.0, 100)
    ...
    tacones = factory_tacones.crearZapato(2, "Prada Elegance", "Formal", 20,
                                          37, "Rojo brillante", "Cuero y acero", 200.0, 30)
